...
var diff = function (filename1, filename2) {
	...
	file1 = stream1.read().toString(); 
	file2 = stream2.read().toString();
...
var testChanges = function(baseString,newString) {
    ...
    var changes = diffLine(baseString,newString);
...
var testFileChanges = function () {
	...
	console.log(fileChanges);
	console.log("applying changes to file1");
	var newFile = applyFileChanges(file1,fileChanges);
	console.log(newFile);
	console.log("reverting changes");
	var oldFile = revertFileChanges(newFile,fileChanges);
	console.log(oldFile);
    }
}
